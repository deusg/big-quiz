...
q2 = ["What is the largest country in the world?", "India", "China", "Russia", "USA", 3]
q3 = ["What is the largest ocean in the world?", "Pacific", "Atlantic", "Indian", "Arctic", 1]
q4 = ["Which planet is closest to the sun?", "Saturn", "Neptune", "Mercury", "Venus", 3]
q5 = ["Where are the pyramids?", "India", "Egypt", "Morocco", "Ethiopia", 2]
